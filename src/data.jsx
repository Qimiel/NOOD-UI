// Fallback / demo data — used until the backend wires real reports through.
// Shape matches the backend report contract from presentation_analyzer.py
// so screens can consume either source interchangeably.
